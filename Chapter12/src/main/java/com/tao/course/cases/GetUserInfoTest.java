...
import com.tao.course.model.GetUserInfoCase;
...
public class GetUserInfoTest {
    ...
    public void getUserInfo() throws IOException, InterruptedException {
        ...
        System.out.println("获取用户信息:" + jsonArray.toJSONString());
        System.out.println("调用接口获取用户信息:" + resultJson);
        Assert.assertEquals(jsonArray.toJSONString().length(), resultJson.length());
    }
